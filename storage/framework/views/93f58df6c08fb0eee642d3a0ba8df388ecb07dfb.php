             ...
             <div class="form-default ">
                      <form action="<?php echo e(route('admin.category.edit',['id'=>$category_data->id])); ?>" id="popForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-sm-6">
							 ...
							 <div class="form-group col-sm-6">
						                  <?php if(Session::has('CategoryeditErrors')): ?>
                                    <?php $__currentLoopData = Session::get('CategoryeditErrors')->get('Code'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $errorMessage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <span class="label label-danger"><?php echo e($errorMessage); ?></span>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                <label class="input-label">Code<span style="color: red">*</span></label>
                                <input type="text" class="form-control" name="code" value="<?php echo e($category_data->code); ?>" required>
                            </div>
							...
							<div class="form-group col-sm-12">
							    ...
							    <input type="text" class="form-control" name="description" value="<?php echo e($category_data->description); ?>" required>
                            </div>
						 ...
						 <div class="form-group row">
						  ...
						  <div class="form-group col-sm-12">
                               ...
                               <select size="100" class="form-control  for-multiple select-form" name="parent_id" >
                                    ...
                                    <?php if($category_data->id <> $category->category_id): ?>
						 ...
						 <div class="form-group col-sm-6">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option <?php if($category_data->status == 1): ?> selected <?php endif; ?> value="1" >Enabled</option>
                                    <option <?php if($category_data->status == 0): ?> selected <?php endif; ?> value="0">Disabled</option>
									 <option <?php if($category_data->status == 2): ?> selected <?php endif; ?> value="2">Archived</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>