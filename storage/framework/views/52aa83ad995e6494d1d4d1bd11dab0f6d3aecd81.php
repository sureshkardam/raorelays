                                     ...
                                     <span class="label label-danger"><?php echo e($errorMessage); ?></span>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       <?php endif; ?>
											...
											<input type="number"   name="contact_number" class="form-control" placeholder="" id="contact_number" value="<?php echo e(old('contact_number')); ?>" required>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/create-user.blade.php ENDPATH**/ ?>