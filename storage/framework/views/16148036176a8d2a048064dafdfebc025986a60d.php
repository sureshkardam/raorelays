<?php $__env->startSection('content'); ?>
	...
	<section class="another-section main-form-seperate">
		...
		<div class="order-title-main"><h1 style="text-align:center;margin-top:5px;margin-bottom:5px;">Order Creation</h1><div class="arrow-down"></div></div>
	        ...
	        <form enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.order.create')); ?>">
				            <?php echo csrf_field(); ?>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-sm-6 plant_block">
	                            ...
	                            <select class="form-control plant" name="plant" class="plant" required>
	                                ...
	                                <option value="<?php echo e($plant->id); ?>"><?php echo e($plant->plant_id); ?></option>
	                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                            </select>
	                        </div>
	            ...
	            <div class="panel panel-primary setup-content" id="step-2">
	                ...
	                <div class="panel-body">
	                    <div class="row">
	                        ...
	                        <div class="form-group col-sm-4">
	                            <label>Email </label>
	                            <input type="text" name="email" class="email form-control" id="email" placeholder="" value="<?php echo e(old('email')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Contact Number </label>
	                            <input type="text" name="mobile" class="mobile form-control" id="mobile" placeholder="" value="<?php echo e(old('mobile')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Additional Contact Number</label>
	                            <input type="text" name="telephone" class="telephone form-control" id="telephone" placeholder="" value="<?php echo e(old('telephone')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Registered Address </label>
	                            <input type="text" name="registered_address" class="form-control registered_address" id="registered_address" placeholder="" value="<?php echo e(old('registered_address')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>City </label>
	                            <input type="text" name="city" class="city form-control" id="city" placeholder="" value="<?php echo e(old('city')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Zip Code </label>
	                            <input type="text" name="zip_code" class="zip_code form-control" id="zip_code" placeholder="" value="<?php echo e(old('zip_code')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>GST </label>
	                            <input type="text" name="gst" class="gst form-control" id="gst" placeholder="" value="<?php echo e(old('gst')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Tin </label>
	                            <input type="text" name="tin" class="tin form-control" id="tin" placeholder="" value="<?php echo e(old('tin')); ?>">
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Payment Terms </label>
	                            <textarea rows="4" id="payment_terms" cols="50" class="form-control payment_terms" name="payment_terms" style="height: 40px;"><?php echo e(old('payment_terms')); ?></textarea>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Preferred Mode of Transport </label>
	                            <textarea rows="4" id="mode_of_transport" cols="50" class="form-control mode_of_transport" name="mode_of_transport" style="height: 40px;"><?php echo e(old('mode_of_transport')); ?></textarea>
	                        </div>
	                    </div>
	                    <div class="buttons-here">
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/order/create.blade.php ENDPATH**/ ?>