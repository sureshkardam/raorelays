  ...
  <?php echo $__env->make('toast', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo e(\App\Category::getCategoryStatus($category->category_id)  ? 'Active' : 'Inactive'); ?></td>
                                    <td><?php echo e(\App\Category::getCreated($category->category_id)); ?></td>
                                    <td><?php echo e(App\Category::getSortOrder($category->category_id)); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/category/list.blade.php ENDPATH**/ ?>