                ...
                <div class="content-main-here">
                    ...
                    <div class="table-main-div">
                        <div class="table-header">
                            <h2><strong>Raw Material Users</strong></h2>
							 <div class="create-button">
                        <a title="Add New" href="<?php echo e(route('create.user')); ?>"><i class="fa fa-plus"></i> Create User</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/raw-user-list.blade.php ENDPATH**/ ?>