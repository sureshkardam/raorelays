                   ...
                   <!--<div class="filter-blocks">
                    ...
                    <div class="table-main-div">
                        <div class="table-header">
                            <h2><strong>Active Customers</strong></h2>
							<div class="create-button">
                        <a title="Add New" href="<?php echo e(route('admin.customer.create')); ?>"><i class="fa fa-plus"></i> Create Customer</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/customer/active-list.blade.php ENDPATH**/ ?>