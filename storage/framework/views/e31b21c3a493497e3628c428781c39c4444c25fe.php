...
<?php $__env->startSection('content'); ?>
       ...
       <?php echo $__env->make('toast', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		...
		<input id="contact_number" type="number"  <?php if($user->apPersonal): ?> value="<?php echo e($user->apPersonal->telephone); ?>" <?php endif; ?> name="contact_number" class="form-control" placeholder="" required> 
                                        </div>
                                            ...
                                            <select class="form-control" name="status" required>
                                              <option <?php if($user->status == 1): ?> selected <?php endif; ?> value="1" selected>Enabled</option>
                                              <option <?php if($user->status == 0): ?> selected <?php endif; ?> value="0">Disabled</option>
											  <option <?php if($user->status == 2): ?> selected <?php endif; ?> value="2">Archived</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/edit-user.blade.php ENDPATH**/ ?>