...
<div class="breadcumbs-area with-label">
                    ...
                    <div class="create-button">
						...
						<a title="Create Order" href="<?php echo e(route('admin.order.create')); ?>"><i class="fa fa-plus"></i> Create Purchase Request</a>
                ...
                <div class="content-main-here">
                    ...
                    <div class="table-main-div">
                        <div class="table-header">
							...
							<a title="Create Purchase Request" href="<?php echo e(route('admin.material.purchase')); ?>"><i class="fa fa-plus"></i> Create Purchase Request</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/material-product/purchase-list.blade.php ENDPATH**/ ?>