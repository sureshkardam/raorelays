...
<?php $__env->startSection('content'); ?>
                ...
                <div class="breadcumbs-area">
                    <ul>
                        <li class="title-main">
                            <h4>Create Material Option</h4>
                        </li>
                        <li class="link-home"><a href="#."><i class="fa fa-home"></i></a></li>
                        <li class="link-home"><a href="#.">Home</a></li>
                        <li class="link-page"><a href="#.">Create Material Option</a></li>
                    </ul>
                ...
                <div class="content-main-here">
                    <div class="table-main-div" style="margin-top: 0px;">
                        <div class=" table-header ">
                            <h2><strong>Create Material Option</strong></h2>
                        </div>
                         <?php if($errors->any()): ?>
...
<i class="fa fa-plus-circle"></i> Create Material Option</button>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/material-option/create.blade.php ENDPATH**/ ?>