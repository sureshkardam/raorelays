<?php $__env->startSection('content'); ?>
    ...
    <div class="breadcumbs-area">
        <ul>
            ...
            <li class="link-page"><a href="#.">Create Product Sub Category</a></li>
        </ul>
    ...
    <div class="content-main-here">
        <div class="table-main-div" style="margin-top: 0px;">
            <div class=" table-header ">
                <h2><strong>Create Product Sub Category</strong> </h2>
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-sm-12">
							 ...
							 <div class="form-group col-sm-12">
                                ...
                                <label for="first name" class="hello">Select Parent Category
...
<i class="fa fa-plus-circle"></i> Create Product Sub Category</button>
                            </div>
                        </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/category/create-sub.blade.php ENDPATH**/ ?>