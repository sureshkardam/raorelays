...
<?php endif; ?>
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
										...
										<?php if($user->user_type == 0): ?> Sales <?php endif; ?>
										<?php if($user->user_type == 2): ?> Sub Admin <?php endif; ?>
										<?php if($user->user_type == 3): ?> Raw Material <?php endif; ?>
										<?php if($user->user_type == 4): ?> Production <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/all-user-list.blade.php ENDPATH**/ ?>