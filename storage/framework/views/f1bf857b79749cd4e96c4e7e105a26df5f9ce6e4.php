...
<div class="breadcumbs-area with-label">
                    <ul>
                        <li class="title-main">
                            <h4>Sales Module Users</h4>
                        </li>
                        <li class="link-home"><a href="#."><i class="fa fa-home"></i></a></li>
                        <li class="link-home"><a href="#.">Home</a></li>
                        <li class="link-page"><a href="#.">Sales Module Users</a></li>
                    </ul>
                ...
                <div class="content-main-here">
                    ...
                    <div class="table-main-div">
                        <div class="table-header">
                            <h2><strong>Sales Module Users</strong></h2>
							<div class="create-button">
                        <a title="Add New" href="<?php echo e(route('create.user')); ?>"><i class="fa fa-plus"></i> Create User</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/sales-user-list.blade.php ENDPATH**/ ?>