<?php $__env->startSection('content'); ?>
	...
	<section class="another-section main-form-seperate">
		...
		<h1 style="text-align:center;margin-top:5px;margin-bottom:5px;">Order Creation</h1>
	        ...
	        <form enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.order.edit',$order->id)); ?>">
				            <?php echo csrf_field(); ?>
 ...
 Company Information</h3>
			...
			<!-- company info -->
					...
					<p><?php echo e($company->registered_address); ?><br><?php echo e($company->city); ?>-<?php echo e($company->zip_code); ?></p>
					</div>

					<div class="contact-details">
					<p>Contacts : <?php echo e($company->telephone); ?>,<?php echo e($company->mobile); ?></p>
					<p>GST No : <?php echo e($company->gst); ?></p>
					<p>Tin No : <?php echo e($company->tin); ?></p>
					</div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-sm-6 plant_block">
	                            ...
	                            <select class="form-control plant" name="plant" required>
	                                ...
	                                <option value="<?php echo e($plant->id); ?>" <?php if($plant->id==$order->plant): ?> selected <?php endif; ?>><?php echo e($plant->plant_id); ?></option>
	                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                            </select>
	                        </div>
							...
							<div class="col-sm-6 plant-add">
								...
								<p id="plant_name"><?php echo e(App\Plant::getName($order->plant)); ?></p>
								<p id="plant_address"><?php echo e(App\Plant::getAddress($order->plant)); ?><p>
								<p id="plant_contact"><?php echo e(App\Plant::getContact($order->plant)); ?><p>
							...
							<div class="col-sm-6">
	                            ...
	                            <input type="text" name="order_date" class="order_date form-control" value="<?php echo e($dateTime->format('d/m/y')); ?>" readonly>
	                        </div>
	                    </div>
	                    <div class="buttons-here">
	                    <div class="pull-right"><a class="btn blue gray" href="<?php echo e(route('admin.order.list')); ?>">Back to Order List</a>    <button class="btn nextBtn pull-right blue green" type="button">Next</button></div>
	                    </div>
	                </div>
	            </div>
	                ...
	                <div class="panel-body">
	                    <div class="row">
	                        <div class="form-group col-sm-12 ">
	                            ...
	                            <input type="text" class="customer form-control" value="<?php echo e($cust_detail->contact_name); ?>" name="customer" required />
								
								<input type="hidden" name="customer_id" value="<?php echo e($order->user_id); ?>"/>
	                        </div>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label for="customer name" class="hello">Customer Name
	                            </label>
	                            <input type="text" name="contact_name" class="contact_name form-control" placeholder="" value="<?php echo e($cust_detail->contact_name); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Customer Code </label>
	                            <input type="text" name="customer_code" class="customer_code form-control" id="customer_code" placeholder="" value="<?php echo e($cust_detail->	customer_code); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Email </label>
	                            <input type="text" name="email" class="email form-control" id="email" placeholder="" value="<?php echo e($cust_detail->email); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Contact Number </label>
	                            <input type="text" name="mobile" class="mobile form-control" id="mobile" placeholder="" value="<?php echo e($cust_detail->telephone); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Additional Contact Number</label>
	                            <input type="text" name="telephone" class="telephone form-control" id="telephone" placeholder="" value="<?php echo e($cust_detail->mobile); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Registered Address </label>
	                            <input type="text" name="registered_address" class="form-control registered_address" id="registered_address" placeholder="" value="<?php echo e($cust_detail->registered_address); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>City </label>
	                            <input type="text" name="city" class="city form-control" id="city" placeholder="" value="<?php echo e($cust_detail->city); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Zip Code </label>
	                            <input type="text" name="zip_code" class="zip_code form-control" id="zip_code" placeholder="" value="<?php echo e($cust_detail->zip_code); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>GST </label>
	                            <input type="text" name="gst" class="gst form-control" id="gst" placeholder="" value="<?php echo e($cust_detail->gst); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Tin </label>
	                            <input type="text" name="tin" class="tin form-control" id="tin" placeholder="" value="<?php echo e($cust_detail->tin); ?>" readonly>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Payment Terms </label>
	                            <textarea rows="4" id="payment_terms" cols="50" class="form-control payment_terms" name="payment_terms" style="height: 40px;" readonly><?php echo e($cust_detail->payment_terms); ?></textarea>
	                        </div>
	                        <div class="form-group col-sm-4">
	                            <label>Preferred Mode of Transport </label>
	                            <textarea rows="4" id="mode_of_transport" cols="50" class="form-control mode_of_transport" name="mode_of_transport" style="height: 40px;" readonly><?php echo e($cust_detail->mode_of_transport); ?></textarea>
	                        </div>
	                    </div>
	                    <div class="buttons-here">
						<div class="pull-right"> <a class="btn blue gray" href="<?php echo e(route('admin.order.list')); ?>">Back to Order List</a> 
 ...
 Product Information</h3>
	                ...
	                <div class="panel-body">
	                            ...
	                            <div class="col-sm-12">
	                                <div class="table option product-add">
	                                   <!-- <input type="hidden" name="customer_id" class="customer_id" />-->
										...
										<input type="text" class="suggestion" value="<?php echo e($product_name); ?>" name="product_name" />
										...
										<option value="<?php echo e($sibling->id); ?>"
										<?php if($sibling->id==$product->product_id): ?> selected <?php endif; ?>
										
										><?php echo e($sibling->code); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select></div>
										...
										<div class="col-sm-2">
										<input type="text" placeholder="Qty" name="qty[]"  value="<?php echo e($product->quantity); ?>" />
										</div>
										
										<div class="col-sm-2">
										<input type="text" name="specification[]" value="<?php echo e($product->specification); ?>" />
										</div>
										
										<div class="col-sm-2">
										<input value="<?php echo e($product->comment); ?>" type="text" name="comment[]" />
										</div>
						...
						<input type="hidden" name="order_id" value="<?php echo e($order->id); ?>" />
	                        ...
	                        <a class="btn blue gray" href="<?php echo e(route('admin.order.list')); ?>">Back to Order List</a>
	                    </div>
	                </div>
	            </div>
	        </form>
...
<script type="text/javascript">
   ...
   // alert(plantID);
	if(plantID){
        $.ajax({
           type: "GET",
           url:"<?php echo e(route('plant.detail')); ?>?plantID="+plantID,
...
$(document).ready(function() {
    ...
    $(".customer").autocomplete({
        source: function(request, response) {
            $.ajax({
                url: "<?php echo e(route('admin.get.customer')); ?>",
                data: {
                    q: request.term
                },
                dataType: "json",
            ...
            select: function(event, ui) {
                ...
                $(this).closest('.dynamic').find('input[name="product_name"]').val(ui.item.label);
							...
							if(product_id){	
								...
								$.ajax({
									url: "<?php echo e(route('admin.get.subproduct')); ?>",
									data: {
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rao-relays\resources\views/admin/order/edit.blade.php ENDPATH**/ ?>