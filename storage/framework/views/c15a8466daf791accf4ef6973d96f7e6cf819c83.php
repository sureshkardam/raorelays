...
<div class="content-main-here prof">
    ...
    text-transform: uppercase;">Rao Electromachanical Relays PVT. LTD.</p>
            ...
            <div class="supplierDetail" style="width:49%;display:inline-block;">
                <div class="detail-here-supp" style="">
                    <h3 style="font-size:18px;font-weight: 600;">Challan No: <?php echo e(json_decode($order->order_id)); ?></h3>
                    <?php if($order->supplier_id): ?>
					<p style="font-size: 15px;margin-top: 5px;">Supplier : <?php echo e(App\Supplier::getName($order->supplier_id)); ?></p>
					<?php endif; ?>
                </div>
            </div>
            ...
            <div class="supplierDate" style="width: 50%;display:inline-block;text-align:right;">
                <div class="Date-here-supp">
                    <p style="font-size:15px;"><b>Date:</b> <?php echo e(date('M\. d\, Y', strtotime($order->purchase_order_date))); ?></p>
                </div>
            </div>
            </div>
		  ...
		  <tr>
          <td style="border:solid 1px #ddd;padding: 9px 10px; background: #eee;"><?php echo e($loop->iteration); ?></td>
          <td style="border:solid 1px #ddd;padding: 9px 10px; background: #eee;"><?php echo e(App\MaterialProduct::getName($product->product_id)); ?></td>
          <td style="border:solid 1px #ddd;padding:9px 10px; background: #eee;"><?php echo e($product->qty); ?></td>
		  <td style="border:solid 1px #ddd;padding:9px 10px; background: #eee;"><?php echo e($product->remarks); ?></td>
		 ...
		 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                ...
                <div class="supplierDetail" style="width:	49%;display:inline-block;">
                    <div class="Date-here-supp">
                        <p style="font-size:15px; margin-bottom: 0;"><b>Date:</b> <?php echo e(date('M\. d\, Y', strtotime($order->purchase_order_date))); ?></p>
                    </div>
                </div>
                <div class="supplierDate" style=" width: 50%;display:inline-block;text-align:right;">
                    <div class="Date-here-supp">
			...
			<div class="MainDivForSupplier" style="margin-top:10px;">
                <div class="supplierDetail" style="width:49%; display:inline-block;">
                    <div class="Date-here-supp">
						 ...
						 <p style="font-size:15px; margin-top: 0;">Requisition Recieved By:</p>
                    </div>
                </div>
                <div class="supplierDate" style="width: 50%; display:inline-block;text-align:right;">
                    <div class="Date-here-supp">
...
</html><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/pdf/print-request.blade.php ENDPATH**/ ?>