...
<div class="breadcumbs-area">
    <ul>
        <li class="title-main">
            <h4>Raw Material Receiving (Job Work)</h4>
        </li>
        <li class="link-home"><a href="#."><i class="fa fa-home"></i></a></li>
        <li class="link-home"><a href="#.">Home</a></li>
        <li class="link-page"><a href="#.">Raw Material Receiving (Job Work)</a></li>
    </ul>
 ...
 <form class="add-patient-form" method="post" action="<?php echo e(route('admin.material.receiving.save')); ?>" enctype="multipart/form-data">
    ...
    <div class="table-main-div">
        <div class="table-header">
            <h2><strong>Raw Material Receiving (Job Work)</strong></h2>
...
<i class="fa fa-plus-circle"></i> Recieve Job Work</button>
                </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/material-product/receiving-jobwork.blade.php ENDPATH**/ ?>