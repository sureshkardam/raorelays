 <?php $__env->startSection('content'); ?>
        ...
        <div class="breadcumbs-area">
            <ul>
                <li class="title-main">
                    <h4>Raw Material Request</h4>
                </li>
                <li class="link-home"><a href="#."><i class="fa fa-home"></i></a></li>
                <li class="link-home"><a href="#.">Home</a></li>
                <li class="link-page"><a href="#.">Raw Material Request</a></li>
            </ul>
        </div>
        <div class="content-main-here">
            <div class="table-main-div">
                <div class="table-header">
                    <h2><strong>Raw Material Request</strong></h2>
                ...
                <form class="add-patient-form" method="post" action="<?php echo e(route('admin.material.request')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-field-here text-center" style="margin-top: 20px">
                        <button id="save_purchase" type="submit" class="btn blue">
                            <i class="fa fa-plus-circle"></i> Create Raw Material Request</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\raorelays\resources\views/admin/material-product/request-raw.blade.php ENDPATH**/ ?>