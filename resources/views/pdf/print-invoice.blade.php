...
<body>
    ...
    width: 110px;">Invoice No.</span> : {{$order->display_order_id}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">Date of Invoice</span> : {{date('M\. d\, Y', strtotime($order->created_at))}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">Place of Supply</span> : {{\App\State::getName($customer->state)}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    ...
    width: 110px;">Vehice No.</span> : DL01LAE 1154</p>
                ...
                <div class="supplierDate" style="width: 50%; vertical-align: top;display:inline-block;">
                    <div class="detail-here-supp" style="padding:10px">
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">Station</span> : {{$customer->city}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    ...
    font-weight:600;">Billed To :</span> {{$customer->contact_name}} <br>
		{{$customer->registered_address}},<br> {{$customer->city}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">State</span> : {{\App\State::getName($customer->state)}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">GSTIN / UIN</span> : {{$customer->gst}}</p>
                    </div>
                </div>
                <div class="supplierDetail" style="width:50%;display:inline-block; vertical-align: top;">
                    <div class="detail-here-supp" style="padding:10px">
                        <p style="font-size:13px; margin: 0; margin-bottom: 10px; color:#525252;"><span style="display: block;
    font-weight:600;">Shipped To :</span> {{$customer->contact_name}}<br>
                           {{$customer->registered_address}},<br> {{$customer->city}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
    width: 110px;">State</span> : {{\App\State::getName($customer->state)}}</p>
                        <p style="font-size:13px; margin: 0; color:#525252;"><span style="display: inline-block;
  ...
  ">
                ...
                <tbody>
					...
					<tr>
                        ...
                        <td>{{App\Product::getHSN($product->product_id)}}</td>
