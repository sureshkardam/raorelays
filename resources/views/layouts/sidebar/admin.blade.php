...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
	 ...
	 <li class="{{ Request::is('create/product') ? 'active' : '' }}"><a href="{{route('admin.product.create')}}">Create Product</a></li>

	   <li class="{{ Request::is('product') ? 'active' : '' }}"><a href="{{route('admin.product.list')}}">Product List</a></li>
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="{{ Request::is('all/user/list') ? 'active' : '' }}">
            <a href="{{route('all.user.list')}}">Users List</a>
        </li>
		<li class="{{ Request::is('subadmin/list') ? 'active' : '' }}">
            <a href="{{route('subadmin.user.list')}}">Admin List</a>
        </li>
		 <li class="{{ Request::is('sales/user/list') ? 'active' : '' }}">
            <a href="{{route('sales.user.list')}}">Sales User List</a>
        </li>
		
		
		 <li class="{{ Request::is('raw/material/user/list') ? 'active' : '' }}">
            <a href="{{route('raw.user.list')}}">Raw Material User List</a>
        </li>
		
		
		 <li class="{{ Request::is('production/user/list') ? 'active' : '' }}">
            <a href="{{route('production.user.list')}}">Production User List</a>
        </li>
