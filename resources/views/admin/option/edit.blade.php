 ...
 <div class="content-area-main">
                <div class="breadcumbs-area">
                    <ul>
                        ...
                        <li class="link-page"><a href="#.">Edit Option</a></li>
                    </ul>
                ...
                <div class="content-main-here">
                    <div class="table-main-div" style="margin-top: 0px;">
                        <div class=" table-header ">
                            <h2><strong>Edit Option</strong> </h2>
                        </div>
             @if ($errors->any())
...
@endif 
             ...
             <div class="form-default ">
                               ...
                               <form class="add-option-form" method="post" action="{{route('admin.option.edit',$option->id)}}" enctype="multipart/form-data">
