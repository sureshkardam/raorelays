...
<div class="breadcumbs-area with-label">
                    ...
                    <div class="create-button">
						...
						<a title="Create Order" href="{{route('admin.material.request')}}"><i class="fa fa-plus"></i> Create Raw Material Request</a>
                    ...
                    <div class="table-main-div">
                        <div class="table-header">
                            <h2><strong>Raw Material Request List</strong></h2>
							 <div class="create-button">
								<a title="Create Raw Material Request" href="{{route('admin.material.request')}}"><i class="fa fa-plus"></i> Create Raw Material Request</a>
