        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-here">
                    ...
                    <form class="row" action="{{route('admin.material.product.list')}}" method="post">
                            ...
                            <td>{{$product->status ? 'Enabled' : 'Disabled' }}</td>
                             <td>{{date('M\. d\, Y', strtotime($product->created_at))}}</td>
                              ...
                              <td>
                                ...
                                <a class="action-dash" href="{{route('admin.material.product.edit',$product->id)}}"><i class="fa fa-pencil" aria-hidden="true" title="Edit"></i></a>

                      
                               

                                 <a onclick="deleteConfirm('material-product',{{$product->id}},'{{$product->name}}')"><i class="fa fa-trash" aria-hidden="true" title="Delete"></i></a> 
