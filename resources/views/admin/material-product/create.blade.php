                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-sm-6">
							  ...
							  <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="minimum_purchase" class="form-control" value="{{old('minimum_purchase')}}" id="name" placeholder="Minimum Quantity" required>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <!-- Quantity -->
                                <input type="text" name="quantity" class="form-control" value="{{old('quantity')}}" id="name" placeholder="Quantity" required>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <!-- Dimension (L X W X H) -->
                                <input type="text" name="tax_rate" class="form-control" value="{{old('tax_rate')}}" placeholder="Tax Rate" required>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <span class="label label-danger">{{$errorMessage}}</span> @endforeach @endif
                                <input type="text" name="weight" class="form-control" value="{{old('weight')}}" placeholder="" required>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <!-- Sort Order -->
                                <input type="text" name="sort_order" class="form-control" value="{{old('sort_order')}}" id="name" placeholder="Sort Order">
                            </div>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea rows="4" id="description" cols="50" class="form-control" name="description" required>{{old('description')}}</textarea>
                            </div>
