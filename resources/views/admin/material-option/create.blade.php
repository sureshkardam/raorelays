                       ...
                       <div class="form-default ">
                               ...
                               <form class="add-patient-form" enctype="multipart/form-data" method="post" action="">
                                   ...
                                   <div class="form-group col-sm-6">
                                    ...
                                    <!--  @if(Session::has('OptionCreateErrors'))
                          @foreach(Session::get('OptionCreateErrors')->get('Name') as $errorMessage)
...
<!-- Sort Order -->
                                            <input type="text" name="sort_order" class="form-control" id="sort_order" placeholder="Sort Order" required>
                                        </div>
                                        <div class="form-group col-sm-6">
<!-- Status -->
