	                ...
	                <div class="panel-body">
	                    <div class="row">
	                        <div class="form-group col-sm-12 ">
	                            ...
	                            <input type="text" class="customer form-control" value="{{App\Customer::getName($order->user_id)}}" name="customer" required />
	                        ...
	                        <div class="form-group col-sm-4">
	                            ...
	                            <input type="text" name="contact_name" class="contact_name form-control" placeholder="" value="{{App\Customer::getName($order->user_id)}}">
	                        </div>
	                        <div class="form-group col-sm-4">
 ...
 Product Information</h3>
	                ...
	                <div class="panel-body">
	                            ...
	                            <div class="col-sm-12">
	                                <div class="table option product-add">
	                                   <!-- <input type="hidden" name="customer_id" class="customer_id" />-->
										...
										<input type="text" class="suggestion" value="{{$product->sku}}" name="product_name" />
						...
						<input type="hidden" name="order_id" value="{{$order->id}}" />
	                        ...
	                        <input type="submit" class="btn blue orange" name="save-exit" value="Save & Exit">
