 ...
 <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
  ...
  <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script>
    ...
    $("button").click(function(){
       $("#inputtext").append("<div class='dynamic'><div class='row'><div class='col-sm-1'><p class='order-number'>'"+count+"'</p></div><div class='col-sm-6'><input type='text' class='suggestion' value='' name='product_name' /><input type='hidden' name='product_ids[]' /></div><div class='col-sm-4'><input type='text' name='qty[]' /></div><div class='col-sm-1'><button class='removeArea' type='button'>Remove</button></div></div></div><br />");
