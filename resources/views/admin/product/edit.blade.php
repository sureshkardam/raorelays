                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="table option">
                                        @if($product->getSubProducts->count() > '0')
                                        <table class="tbllOption table table-bordered has-option">
                                            ...
                                            <tbody>
                                                @foreach($product->getSubProducts as $sub)
                                                <tr class="clonemeOption">
                                                    <td class="attribute-box">
                                                        <div class="input-attribute">
                                                           <input type="text" name="sub_product_code[]" value="{{$sub->code}}" required />  
                                                        </div>
                                                    </td>
													
													 <td class="attribute-box">
                                                        <div class="input-attribute">
                                                           <input type="text" name="sub_product_quantity[]" value="{{$sub->quantity}}" required />  
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="test">
                                                       ...
                                                       <input type="text" name="sub_product_description[]" value="{{$sub->description}}" required />     
                                                        </div>
                                                    </td>
